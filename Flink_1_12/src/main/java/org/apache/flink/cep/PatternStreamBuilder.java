...
final class PatternStreamBuilder<IN> {
    ...
    static <IN> PatternStreamBuilder<IN> forStreamAndPattern(
            final DataStream<IN> inputStream, final InjectionPatternFunction<IN> injectionPatternFunction) {
        return new PatternStreamBuilder<>(
                inputStream, injectionPatternFunction, TimeBehaviour.EventTime, null, null);
    }
}
